                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <?php $no=1; ?>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" last">
                                <a class="btn btn-info fa fa-pencil-square-o" href="{{ route('detailkonfir', $key->id) }}" data-toggle="tooltip" data-placement="left" title="" data-original-title="Ubah Status">  </a>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
